...
if (isset($_POST['update'])) {
    ...
    $query2 = "UPDATE gebruikers set naam = '$naam', studentmail = '$studentmail', password = '$password', adres = '$adres', woonplaats = '$woonplaats', telnummer = '$telnummer', geboortedatum = '$geboortedatum', geslacht = '$geslacht' WHERE id='$userID'";
    ...
    <div class="row">
        <div class="col-md-4 mx-auto">
            <div class="card card-body">
                <form action="edit_inschrijf.php?userID=<?php echo $_GET['userID']; ?>" method="POST">
