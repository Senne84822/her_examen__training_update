...
<body>
    ...
    //Deze echo's waren voor het testen of de juiste id en level waren meegegeven
...
<center>
    ...
    <form method="post" action="">
        <table border="0">
            ...
            <tr>
                <td>&nbsp;</td>
                <td><a>Nog geen account? <a class="btn btn-warning btn-block" href='registreer.php'>Registreer hier!</a></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
