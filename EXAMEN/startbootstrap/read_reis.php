      ...
      <table class="table table-bordered">
        ...
        <!-- pak en echo de resultaten uit de database in de tabel -->
          ...
          <tr>
            ...
            {  ?>
            <td>
              <a href="edit.php?reisID=<?php echo $row['reisID']?>" class="btn btn-secondary">
              ...
              <div class="card card-body">
                  <form action="save_task.php" method="POST">
                      <div class="form-group">
                          <input type="text" name="title" class="form-control" required placeholder="Reis Titel" autofocus>
                      </div>
                      <div class="form-group">
                          <textarea name="omschrijving" rows="2" class="form-control" required placeholder="Reis Omschrijving"></textarea>
                      </div>
                      ...
                      <div class="form-group">
                          <textarea name="bestemming" rows="2" class="form-control" required placeholder="Bestemmig"></textarea>
                      </div>
                      <input type="submit" name="save_task" class="btn btn-success btn-block" value="Save Reis">
                  </form>
              </div>
              <?php
          }
